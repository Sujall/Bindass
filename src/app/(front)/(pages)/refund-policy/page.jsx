        ...
        <div className="space-y-5 text-gray-700">
          <section className="space-y-3">
            ...
            <p className="text-sm leading-relaxed">
              ...
              your purchase. The product or service must be unused and in the
          ...
          <section className="space-y-3">
            ...
            <ol className="list-decimal pl-5 space-y-2 text-sm">
              ...
              <li>
                Allow 5-10 business days for the refund to reflect in your
                account
              </li>
            </ol>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm leading-relaxed">
              If you haven't received your refund within 10 business days, first
              check with your bank. Then contact your credit card company as it
              may take time before the refund is posted. If you still haven't
              received your refund, please contact us at bindaaspay@gmail.com.
            </p>
          </section>
          ...
          <div className="p-4 bg-blue-50 rounded-lg border border-blue-100 mt-6">
            ...
            <p className="text-sm text-blue-600">
              ...
              <span className="font-medium">bindaaspay@gmail.com</span> for any
